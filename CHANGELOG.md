...
- Validada la captura opcional de Servicio y Curso/año por alumno.
- Validada la hoja Detalle_Alumnos en Excel admin y Excel consulta.
- Añadido patrón de turno deslizante individual por alumno deslizante.
- Añadido “Máster” en Nivel Estudio II.
- Permitida titulación libre para Universitario + Máster/Otro.
- Conservado Dashboard sin cambios.
- Conservado PDF principal sin cambios.
- Validada compatibilidad con usuario normal, multiusuario, admin, publicación y consulta.
